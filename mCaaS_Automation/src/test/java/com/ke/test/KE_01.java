...
public class KE_01 {
	public static void main(String[] args) throws InterruptedException, ElementNotVisibleException {
		Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\F&S\\Fns_Automation\\KE_New_Approach_4k\\Test_data_260\\Final_data\\KE_Backup_final_questions\\Test_data_keywords_industry_updated.xlsx");
		...
		for(int i=2;i<=3850;i++){
			...
			//url
			try{
				wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[1]/div/div[1]/span[2]")));
			...
			try{
				wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[1]/div")));
				WebElement No_KW = driver.findElement(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[1]/div"));
