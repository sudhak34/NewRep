...
public class Reserach_Rendering_Optimization {

	public static void main(String[] args) throws InterruptedException {
		//String downloadPath = "C:\\Users\\sudhakar.koduri\\Downloads";
		Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\F&S\\Short_url\\1k_ids_01.xlsx");
        ...
        System.out.println(option_value);
	        ...
	        option.click();
	    		...
	    		driver.findElement(By.xpath(".//*[@id='header']/div[1]/div/div/div/div[2]")).click();
	    		//driver.findElement(By.xpath(".//*[@id='share_research_tour']/a/div")).click();
	    		driver.findElement(By.xpath(".//*[@id='download_pdf_tour']/a/div")).click();
	    		Thread.sleep(3000);
	    		driver.findElement(By.xpath(".//*[@id='download_pdf_tour']/ul/li/button")).click();
	    		Thread.sleep(15000);
	    		}
