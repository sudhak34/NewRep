...
public class ke_api_test_01 {
	public static void main(String[] args) {
		
		     Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\F&S\\Fns_Automation\\PKW_Data_set\\300\\308_poc_ke_02.xlsx");
			 int rowCount = xl.getRowCount("Sheet1");
		       for(int j=1000;j<=1801;j++){
			try {
			      ...
			      // String Title_01 = xl.getCellData("Sheet1", "Title", j);
			       ...
			       String API="http://169.46.44.140:8085/response?queryInput="+question+"&enterpriseUserID=be7a1574-9884-11e790f8-3ed4ee2a58e9";
			      ...
			      // String encodeQuery = URIUtil.encodeQuery(API);
			       ...
			       //String encodeQuery = URIUtil.encodeQuery("http://169.46.96.206:8080/chatbots?type=damac&queryInput="+input+"&companyname=");
					...
					String s2 =prettyJsonString.substring(prettyJsonString.indexOf("Research_Name"));
