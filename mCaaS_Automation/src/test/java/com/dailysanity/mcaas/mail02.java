...
public class mail02 extends icm_daily_sanity_check {
	  public static void sendemail(String output,String output1,String output2,String output3) {
		...
		try {
			...
			message.setSubject("mCaaS Production URL's Working status as on -"+" "+ZonedDateTime.now());
