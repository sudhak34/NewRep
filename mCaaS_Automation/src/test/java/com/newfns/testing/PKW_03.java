...
public class PKW_03 {
	public static void main(String[] args) throws InterruptedException, ElementNotVisibleException {
		Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\F&S\\Fns_Automation\\PKW_Data_set\\New folder\\Query.xlsx");
		...
		for(int i=8;i<=211;i++){
			...
			Thread.sleep(5000);
			try{
			//if(driver.findElement(By.xpath("//img[@src='/core/images/down_arrow.png']")).isDisplayed()){
				wait4.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[2]/span/span[1]/img")));
				if(driver.findElement(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[2]/span/span[1]/img")).isDisplayed()){
				WebElement expanded_image_button = driver.findElement(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[2]/span/span[1]/img"));	
		    	expanded_image_button.click();
		    	
		    	for(int p=1;p<=4;p++){
		    		//Thread.sleep(2000);
		    	String text = driver.findElement(By.xpath("html/body/div[3]/div[4]/chatbot/div[1]/div/div/div[2]/div/div[1]/div["+j+"]/div/div[2]/div["+p+"]/a")).getText();
		    	System.out.println(text);
		    	if(p==1){
		    	xl.setCellData("Sheet1","Suggestive_questions_01",i,text);
		    	}
		    	if(p==2){
			    	xl.setCellData("Sheet1","Suggestive_questions_02",i,text);
			    	}
		    	if(p==3){
			    	xl.setCellData("Sheet1","Suggestive_questions_03",i,text);
			    	}
		    	if(p==4){
			    	xl.setCellData("Sheet1","Suggestive_questions_04",i,text);
			    	}
		    	}
		    	}
			}
