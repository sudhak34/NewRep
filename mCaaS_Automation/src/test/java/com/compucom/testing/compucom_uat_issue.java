...
public class compucom_uat_issue {

	public static void main(String[] args) {
		try {
		       Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\Compucom_migration\\Automation_Persona\\Knumber - QA.xlsx");
		       int rowCount = xl.getRowCount("Sheet1");
		       for(int j=56;j<=rowCount;j++){
		       ...
		       String API="https://api.us.apiconnect.ibmcloud.com/hmbmadminhappiestmindscom-prodcc/sb/api/v1.0/fedSearch?index=uat.compucom.clp.v1&type="+Company+"&queryType=questions&Knumber=500&client_id=8dc4cc53-1612-4fcb-a9f5-226a2f2a0794&client_secret=Q0uR1yB7bS2lH8iA6gH2iI3jG3uY0jX5hE8bV8hW6xI3mG3hC7";
