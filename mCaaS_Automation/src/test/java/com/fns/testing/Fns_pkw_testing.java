...
public class Fns_pkw_testing {

	public static void main(String[] args) throws InterruptedException, ElementNotVisibleException {
		Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\F&S\\PKW_nov_07\\Test.xlsx");
		int rowCount = xl.getRowCount("Sheet12");
