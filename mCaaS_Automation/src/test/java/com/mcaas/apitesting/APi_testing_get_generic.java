...
public class APi_testing_get_generic {
	public static void main(String[] args) {
		try {
		       Xls_Reader xl=new Xls_Reader("D:\\Sudhakar_Data\\Backup\\E\\KIA\\KIA_Testing_29102017\\Second_Round\\Generic_Chat_DataSet.xlsx");
		       int rowCount = xl.getRowCount("Sheet1");
		       for(int j=2;j<=rowCount;j++){
		    	   System.out.println(j);
		       String Input = xl.getCellData("Sheet1", "Question", j);
		       String expected = xl.getCellData("Sheet1", "Expected", j);
		       String API="http://169.46.44.131:8080/kia_response?companyname=KIA&userId=2&emailId=ss@gmail.com&queryInput="+Input+"&convId=345";
