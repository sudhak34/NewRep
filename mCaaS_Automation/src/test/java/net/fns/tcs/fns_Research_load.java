...
public class fns_Research_load extends Utils {
	...
	public static void sendemail(){
		fns_sanity_suite.sendemailtoteam_Researchload(PDF_Res_obj.AssetID,PDF_Res_obj.Research_loadtime,PDF_Res_obj.PDF_download_time,PDF_Res_obj.Research_load,PDF_Res_obj.PDF_Download);
	}
}
*/
	...
	public static void KEresposnecheck() throws Throwable{
		...
		try{
			...
			softAssertion.assertTrue(true);
			softAssertion.assertAll();
			KE_Status="<b><span style=color:green>Pass</span></b>";
			
		}catch (Throwable e) {
			KE_Status="<b><span style=color:red>Fail</span></b>";
			Log.error(e.getMessage());
			e.printStackTrace();
			Utils.setResult(Utils.resultOnFailure);
			throw e;
	...
	public static void  Augsearchsposnecheck() throws Throwable{
		...
		try{
			...
			softAssertion.assertTrue(true);
			softAssertion.assertAll();
            Aug_search_Status="<b><span style=color:green>Pass</span></b>";
		}catch (Throwable e) {
			Aug_search_Status="<b><span style=color:red>Pass</span></b>";
			Log.error(e.getMessage());
			e.printStackTrace();
			Utils.setResult(Utils.resultOnFailure);
			throw e;
	...
	@Test(priority = 3)
	public static void sendemailtoteam(){
		fns_sanity_suite.sendemailtoteam(PDF_Res_obj.AssetID_01,PDF_Res_obj.Research_loadtime_01,PDF_Res_obj.Research_load_01,
				PDF_Res_obj.AssetID_02,PDF_Res_obj.Research_loadtime_02,PDF_Res_obj.Research_load_02,
				PDF_Res_obj.AssetID_03,PDF_Res_obj.Research_loadtime_03,PDF_Res_obj.Research_load_03);
	
	}
		/*fns_sanity_suite.sendemailtoteam_Researchload(PDF_Res_obj.AssetID_01,PDF_Res_obj.Research_loadtime_01,PDF_Res_obj.Research_load_01,PDF_Res_obj.Research_loadtime_01,PDF_Res_obj.Research_load_01);
